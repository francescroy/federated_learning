...
sudo docker run --rm --name fl-client -p 5000:5000 -e CLIENT_URL='http://10.228.207.201:5000' -e SERVER_URL='http://10.139.40.19:5000' -v /home/francesc/Escritorio/datasets:/federated-learning-network/datasets -v /home/francesc/Escritorio/initial_models:/federated-learning-network/initial_models fl-client:latest
